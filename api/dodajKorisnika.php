...
//rola iz url-a u zavisnosti da li se nalazi na stranici zaposleniAdmin ili korisniciAdmin
$rola = $_GET['rola'];
...
if ($metoda == 'POST'){
   ...
   // $potvrdjenaLozinka = $data['password_confirmation'];
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if($rola == 2){
            //uzeti sve serviceID sa fronta koji su oznaceni i onda koliko ih ima, toliko puta ubaciti u tabelu koja ih povezuje - korisnicki id i svi id-evi
            $idUsluge = $data['usluga'];
